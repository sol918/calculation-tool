...
export const STANDARD_CATEGORIES: StandardCategory[] = [
  ...
  { label: "Module Aantal BG",              unit: "stuks",description: "Modules op begane grond (afgeleid uit BGG)" },
  { label: "Module Aantal Dak",             unit: "stuks",description: "Modules met dakopbouw (afgeleid uit BGG)" },
  { label: "Module Aantal Tussenvd",        unit: "stuks",description: "Modules op tussenverdiepingen" },
